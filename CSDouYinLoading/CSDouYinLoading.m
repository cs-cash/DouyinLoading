...
@implementation CSDouYinLoading

#pragma mark -
#pragma mark 显示/隐藏方法

+ (instancetype)showInView:(UIView *)view {
    CSDouYinLoading *loading = [[CSDouYinLoading alloc] initWithFrame:view.bounds];
...
+ (BOOL)hideInView:(UIView *)view {
    ...
    for (UIView *subview in subviewsEnum) {
        if ([subview isKindOfClass:self]) {
            CSDouYinLoading *loading = (CSDouYinLoading *)subview;
